...
//function generating key of size 256 bits and intialization parameter of 128bits which is used for encryption and decryption .
        try {
            ...
            try {
                ...
                BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/aarushisinghal/desktop/key.txt"));
                writer.write(s);
                writer.close();
           } catch (Exception e) {
...
//used for encryption of data by reading the key from the file and resulting ciphertext is written in cipher.txt file.
     StringBuilder text = new StringBuilder();
        ...
        try {
            FileInputStream fis1 = new FileInputStream("/Users/aarushisinghal/desktop/plaintext.txt");
            int y;
            do {
                y = fis1.read();
                if (y == -1) {
        ...
        byte[] ivp= toByteArray(ivh.toString());
           ...
           System.out.println("cipherText      " +ci);
            ...
            BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/aarushisinghal/desktop/ciphertext.txt"));
                writer.write(ci);
                writer.close();
        } catch (Exception e) {
            System.out.println("file doesnot exist" + e);
    ...
    {  StringBuilder ke = new StringBuilder();
        ...
        try {
           ...
           byte [] data= toByteArray(ci.toString());
            ...
            BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/aarushisinghal/desktop/result.txt"));
